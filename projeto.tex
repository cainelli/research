...
O conjunto de dados utilizado a ser utilizado neste trabalho trata-se de uma coleção de e-mails retirados de um ambiente real de uma empresa provedora de serviços. 
 Para os experimentos realizados neste trabalho foram coletados 4 milhões de mensagens de e-mail. No geral, essas mensagens de e-mail seguem as RFCs 822, 2045, 2046, 2047, 4288, 4289 e 2049,
...
Para os experimentos realizados no Capítulo \ref{sec:experimentos} a base total foi segmentada nos seguintes sub-conjunto de dados:
...
Na Tabela \ref{tab-base-de-dados} vemos a descrição das bases utilizadas neste trabalho. A $Amostra\ Reduzida$ extraída da base $Total$ foi utilizada para determiar o número ideal de tópicos
 ...
 de serviços. Essa abordagem foi proposta pois o autor possui domínio sobre o conteúdo dessa base. Em mineração de dados é comum a utilização de especialistas
...
Possui uma API RESTful de busca e análise e diversos métodos de ingestão, via API ou SDKs suportadas em diversas linguagens:
 ...
 de um conector para Haddop, popular Framework para \textit{Big Data}, fornecendo integrações com outras ferramentas conhecidas como Spark, Spark Streeming, Spark SQL,
 Hive, Pig, Storm, Cascading e MapReduce. Neste trabalho foi utilizado a versão em container do Elasticsearch pela sua facilidade de implementação e utilização e o SDK em Python como cliente para interagir com o componente. 
...
Abaixo, alguns conceitos importantes do Elasticsearch que devem ser abordados:
 ...
 \begin{itemize}
   ...
   \item \textbf{documento:} Unidade básica de informação que pode ser indexada. É expessado na forma de um objeto JSON(JavaScript Object Notation).
 \end{itemize}
