\documentclass[12pt,a4paper]{article}
  ...
  \item \textbf{Calculo de Probabilidade:} É calculado a probabilidade dessas palavras ocorrerem de forma conjunta e pode ser calculado por:
  
  \[P(w_i,w_j) = \frac{Numero\ de\ documentos\ que\ contem\ palavras\ w_i\ e\ w_j}{Total\ de\ documentos}\]
  ...
  % \end{equation}
  \item \textbf{Agregação:} Por fim, todas as confirmações de todos conjuntos de pares $S_i$ são agregados em uma única pontuação de coerência.
  \end{enumerate}
