...
Os documentos são indexados e estruturados no Elasticsearch como descrito na seção 3.1, o próprio motor de busca possui mecanismos para fornecer os tipos de busca e filtros propostos,
...
O LDA não possui conhecimento prévio sobre o número de tópicos otimizado para o conjunto de dados entregue ao modelo. Dessa forma,
 é esperado como parâmetro de entrada a definição prévia do valor de $K$. Como descrito no capítulo 3.2, foi proposto uma série de valores
 de tópicos para se obter o valor de $K$ otimizado para o conjunto de dados via medida de coerência.
...
Na Figura \ref{fig-cm-4-to-64}, vemos a sensitividade da medida de coerência para cada valor de K. Nota-se que a maior coerência, dados esses 
valores de $K$ é 8. No entanto, 8 não necessáriamente é o valor ideal de tópicos, com o experimento acima sabemos apenas que o valor ideal está entre 4 e 16.
...
Rodando o modelo novamente com diferentes números de tópicos nessa faixa, nota-se pela medida de coerência que o valor ideal de tópicos para esse 
 conjunto de dados é 15, como apresentado na Figura \ref{fig-cm-4-to-64}.

\subsection{RESULTADOS INICIAIS}

Neste capítulo, são apresentados os resultados iniciais com bases reduzidas. Para cada experimento são executados todos os processos citados
 neste trabalho, inclusive definições de parâmetros, o que pode afetar o número de tópicos dependendo da base utilizada.

No experimento seguinte, a base foi amostrada com 10\% dos documentos, esse corpus teve valor otimizado do parâmetro $K=5$.
Os rótulos dos tópicos apresentados foram criados com base na interpretação do autor.
