...
No trabalho dos autores \citeonline{blei2003latent} foi proposto um algoritmo chamado Latent Dirichlet Allocation (LDA) \cite{blei2003latent} que possibilita descobrir tópicos intrinsicamente presentes em uma base de dados textual, a partir da sumarização de palavras relevantes. Em complemento ao LDA, os autores  \citeonline{sievert2014ldavis} propõem o LDAVis como uma proposta de visualizar os tópicos descobertos em uma base textual e as palavras que os descrevem. 
