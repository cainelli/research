...
\textbf{\large Latent Dirichlet Allocation: Descoberta e exploração de tópicos, documentos e comunidades em dados textuais.}\\
\vskip 4.5cm
\end{center}
...
Frequentemente, e-mails são deixados fora da equação pela falta de ferramentas específicas e complexidade em tratar dados não estruturados,
 ...
 links e busca, \citeonline{blei2012probabilistic}. 
